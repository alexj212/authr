export PROJ_PATH=github.com/alexj212/authr
...
all: example example-mux ## build binaries in bin dir and run tests

binaries: example example-mux ## build binaries in bin dir
...
example-mux: build_info ## build example-mux binary in bin dir
	@echo "build example-mux"
	@cd  example-mux
	make BIN_NAME=example-mux APP_PATH=. build_app
	@echo ''
	@echo ''
